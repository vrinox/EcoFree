...
Cabecera.prototype.construir = function(){
	...
	elemento.innerHTML = "<button type='button' menuBtn id='menuBtn'><i class='material-icons md-36 white'>menu</i></button><div titulo>Plantilla</div>";
		...
		this.construirNodo = function(){
			...
			switch(this.atributos.tipo){
				...
				case 'detalle':
					...
					nodo.classList.add('mat-orange500');
				break;
				case 'asignar-rol':
...
var Lista = function(data){
  ...
  Lista.prototype.removerContenedorCarga = function(){
    var nodo = this.nodo.querySelector('section[contenedorCarga]');
    nodo.parentNode.removeChild(nodo);
  };
