...
function activarEmpresas(){
  ...
  var empresas = contenedor.querySelectorAll('article:not([add])');
  if(contenedor.querySelector('article[add]')){
    contenedor.querySelector('article[add]').onclick = asignarEmpresa;
  }
  for (var i = 0; i < empresas.length; i++) {
